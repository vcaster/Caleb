...
div{
	...
	<fieldset>
		<input type="text" Name="Search" value="" placeholder="Search Name / Number">
		<input type="Submit" Name="SearchButton" value="Search">
            ...
            <?php 
                ...
                if(isset($_GET['Search'])){
                    ...
                    $search = $_GET['Search'];
        $sql="SELECT * FROM alumni_records WHERE name='$search' OR numbers = '$search'";
	...
	$Department=$DataRows['department'];
        ...
        ?>
            <table width="1000" border="5" align="center">
                <caption>Search From DataBase</caption>
		<tr>
			<th>ID</th>
			<th>Name</th>
			<th>Email</th>
			...
			<th>New</th>
                ...
                <tr>
                        ...
                        <td><a href="search_db.php"> New</a></td>
