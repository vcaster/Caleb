...
//        $Post=mysqli_real_escape_string($conn,$_POST["Post"]);
        ...
        if(isset($username) && isset($passwordlogin)){
            ...
            if($seenuser){
                ...
                $_SESSION['phoneno'] = $seenuser['phoneno'];
                $_SESSION['email'] = $seenuser['email'];
                
                if ($_SESSION['User_Cat'] == 1){
                    
                    $_SESSION['User_Username'] = strtoupper($seenuser['surname']).' '. strtoupper($seenuser['firstname']);
                    $_SESSION['SuccessMessage'] = "Welcome {$_SESSION['User_Username']} ";
                    redirect("USER/blogger.php");
                }
                elseif ($_SESSION['User_Cat'] == 0){
                    $_SESSION['User_Username'] = strtoupper($seenuser['email']);
                    $_SESSION['SuccessMessage'] = "Welcome {$_SESSION['User_Username']} ";
...
//                                    $yearr++
            ...
            <div class="infologin">
                ...
                <form action="index.php" method="post">
                     ...
                     <input type="text" name="username" placeholder="E-mail or Matric No" id="Username">                                           
