...
<button><a  style="margin-left: 1%;" href="../registration.php" class="btn btn-success">ADD NEW ALUMNI</a></button> <button id="excel" class="btn btn-success">EXPORT TO EXCEL</button>
<div>
