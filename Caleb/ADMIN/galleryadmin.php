...
if(empty($Title)){
	...
	global $conn;
	$sql="INSERT INTO gallery(datetime,title,image)
	VALUES('$DateTime','$Title','$Image')";
	$Execute = mysqli_query($conn,$sql);
        move_uploaded_file($_FILES["Image"]["tmp_name"],$Target);
	if($Execute){
	$_SESSION["SuccessMessage"]="Image Added Successfully";
	redirect("galleryadmin.php");
	}else{
    ...
    <div class="cols-grids panel-widget">
        ...
        <div>
            <form action="galleryadmin.php" method="post" enctype="multipart/form-data">
                    ...
                    <br>
            <input class="btn btn-success btn-block" type="Submit" name="Submit" value="Add New Image">
                    </fieldset>
                    <br>
            </form>
            </div>
